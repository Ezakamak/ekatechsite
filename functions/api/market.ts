...
const STOCKS: StockSeed[] = [
  ...
  { symbol: "MGROS", name: "Migros", sector: "Perakende", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Perakende ve gıda zinciri temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents retail and food chain themes.", price: 82, volatility: 0.04, risk: "low" },
  { symbol: "THY", name: "Türk Hava Yolları", sector: "Ulaşım", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Havacılık ve yolcu taşımacılığı temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents aviation and passenger transport themes.", price: 142, volatility: 0.068, risk: "high" },
  { symbol: "TUPRS", name: "Tüpraş", sector: "Enerji", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Enerji ve rafineri temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents energy and refinery themes.", price: 118, volatility: 0.056, risk: "medium" },
  { symbol: "TCELL", name: "Turkcell", sector: "Telekom", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Telekom ve dijital servis temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents telecom and digital service themes.", price: 74, volatility: 0.045, risk: "medium" },
  { symbol: "ASELS", name: "Aselsan", sector: "Savunma", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Savunma teknolojileri temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents defense technology themes.", price: 96, volatility: 0.062, risk: "medium" },
  { symbol: "BIM", name: "BİM", sector: "Perakende", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. İndirim market ve temel tüketim temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents discount retail and staples themes.", price: 69, volatility: 0.034, risk: "low" },
  { symbol: "SISE", name: "Şişecam", sector: "Sanayi", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Cam, kimya ve sanayi temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents glass, chemicals and industrial themes.", price: 58, volatility: 0.049, risk: "medium" },
  { symbol: "ARCLK", name: "Arçelik", sector: "Dayanıklı Tüketim", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Beyaz eşya ve teknoloji üretimi temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents home appliances and technology manufacturing themes.", price: 64, volatility: 0.052, risk: "medium" },
  { symbol: "FROTO", name: "Ford Otosan", sector: "Otomotiv", descriptionTr: "OFF simülasyon varlığıdır; gerçek şirket/hisse verisi değildir. Otomotiv üretimi ve ihracat temasını temsil eder.", descriptionEn: "OFF simulation asset; not real company/stock data. Represents automotive production and export themes.", price: 136, volatility: 0.06, risk: "high" },
];
...
async function getMarketState(context: any, userId: number, rewards: RewardSeed[] = []) {
  ...
  const historyRows = (await db.prepare(`SELECT symbol, price FROM market_price_history ORDER BY id DESC LIMIT 140`).all())?.results || [];
