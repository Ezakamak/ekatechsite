...
const STOCKS: StockSeed[] = [
  ...
  { symbol: "SOKM", name: "Şok Marketler", sector: "Perakende", descriptionTr: `${SIMULATION_NOTE_TR} İndirim market ve yaygın mağaza ağı temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents discount retail and store network themes.`, price: 42, volatility: 0.043, risk: "medium" },
  { symbol: "TKNSA", name: "Teknosa", sector: "Perakende", descriptionTr: `${SIMULATION_NOTE_TR} Teknoloji perakendesi ve elektronik satış temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents technology retail and electronics sales themes.`, price: 36, volatility: 0.064, risk: "high" },
  { symbol: "MAVI", name: "Mavi", sector: "Tekstil", descriptionTr: `${SIMULATION_NOTE_TR} Hazır giyim, marka mağazacılığı ve tüketici talebi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents apparel, branded retail and consumer demand themes.`, price: 52, volatility: 0.055, risk: "medium" },
  { symbol: "KOTON", name: "Koton", sector: "Tekstil", descriptionTr: `${SIMULATION_NOTE_TR} Moda perakendesi ve sezonluk talep temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents fashion retail and seasonal demand themes.`, price: 31, volatility: 0.061, risk: "medium" },
  { symbol: "ULKER", name: "Ülker", sector: "Gıda İçecek", descriptionTr: `${SIMULATION_NOTE_TR} Atıştırmalık, gıda üretimi ve marka tüketimi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents snacks, food production and branded consumption themes.`, price: 71, volatility: 0.041, risk: "low" },
  { symbol: "PNSUT", name: "Pınar Süt", sector: "Gıda İçecek", descriptionTr: `${SIMULATION_NOTE_TR} Süt ürünleri ve temel gıda tüketimi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents dairy products and staple food consumption themes.`, price: 47, volatility: 0.044, risk: "medium" },
  { symbol: "AEFES", name: "Anadolu Efes", sector: "Gıda İçecek", descriptionTr: `${SIMULATION_NOTE_TR} İçecek üretimi, dağıtım ve marka tüketimi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents beverage production, distribution and branded consumption themes.`, price: 93, volatility: 0.046, risk: "medium" },
  { symbol: "TAVHL", name: "TAV Havalimanları", sector: "Ulaşım", descriptionTr: `${SIMULATION_NOTE_TR} Havalimanı işletmeciliği ve turizm trafiği temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents airport operations and tourism traffic themes.`, price: 87, volatility: 0.06, risk: "medium" },
  { symbol: "DOAS", name: "Doğuş Otomotiv", sector: "Otomotiv", descriptionTr: `${SIMULATION_NOTE_TR} Otomotiv distribütörlüğü ve iç pazar talebi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents automotive distribution and domestic demand themes.`, price: 79, volatility: 0.058, risk: "medium" },
  { symbol: "OTKAR", name: "Otokar", sector: "Otomotiv", descriptionTr: `${SIMULATION_NOTE_TR} Ticari araç, savunma aracı ve üretim temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents commercial vehicles, defense vehicles and manufacturing themes.`, price: 128, volatility: 0.069, risk: "high" },
  { symbol: "TTRAK", name: "Türk Traktör", sector: "Otomotiv", descriptionTr: `${SIMULATION_NOTE_TR} Tarım araçları, üretim ve ihracat temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents agricultural vehicles, manufacturing and export themes.`, price: 122, volatility: 0.056, risk: "medium" },
  { symbol: "ASUZU", name: "Anadolu Isuzu", sector: "Otomotiv", descriptionTr: `${SIMULATION_NOTE_TR} Ticari araç ve şehir içi ulaşım üretimi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents commercial vehicles and urban transport manufacturing themes.`, price: 74, volatility: 0.065, risk: "high" },
  { symbol: "YKBNK", name: "Yapı Kredi", sector: "Bankacılık", descriptionTr: `${SIMULATION_NOTE_TR} Bankacılık, kredi hacmi ve faiz döngüsü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents banking, credit volume and rate cycle themes.`, price: 48, volatility: 0.06, risk: "medium" },
  { symbol: "HALKB", name: "Halkbank", sector: "Bankacılık", descriptionTr: `${SIMULATION_NOTE_TR} Kamu bankacılığı ve kredi politikası temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents public banking and lending policy themes.`, price: 34, volatility: 0.067, risk: "high" },
  { symbol: "VAKBN", name: "VakıfBank", sector: "Bankacılık", descriptionTr: `${SIMULATION_NOTE_TR} Kamu bankacılığı, mevduat ve kredi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents public banking, deposits and lending themes.`, price: 39, volatility: 0.064, risk: "high" },
  { symbol: "TSKB", name: "TSKB", sector: "Bankacılık", descriptionTr: `${SIMULATION_NOTE_TR} Kalkınma bankacılığı ve proje finansmanı temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents development banking and project finance themes.`, price: 28, volatility: 0.052, risk: "medium" },
  { symbol: "ANSGR", name: "Anadolu Sigorta", sector: "Sigorta", descriptionTr: `${SIMULATION_NOTE_TR} Sigortacılık, prim üretimi ve hasar döngüsü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents insurance, premium production and claims cycle themes.`, price: 46, volatility: 0.049, risk: "medium" },
  { symbol: "TURSG", name: "Türkiye Sigorta", sector: "Sigorta", descriptionTr: `${SIMULATION_NOTE_TR} Sigorta portföyü ve finansal hizmetler temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents insurance portfolio and financial services themes.`, price: 41, volatility: 0.05, risk: "medium" },
  { symbol: "DOHOL", name: "Doğan Holding", sector: "Holding", descriptionTr: `${SIMULATION_NOTE_TR} Çok sektörlü yatırım ve iştirak portföyü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents diversified investment and subsidiaries themes.`, price: 38, volatility: 0.052, risk: "medium" },
  { symbol: "AGHOL", name: "Anadolu Grubu Holding", sector: "Holding", descriptionTr: `${SIMULATION_NOTE_TR} Gıda, içecek, otomotiv ve perakende iştirakleri temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents food, beverage, automotive and retail subsidiaries themes.`, price: 86, volatility: 0.047, risk: "medium" },
  { symbol: "ALARK", name: "Alarko Holding", sector: "Holding", descriptionTr: `${SIMULATION_NOTE_TR} Enerji, taahhüt ve yatırım portföyü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents energy, contracting and investment portfolio themes.`, price: 75, volatility: 0.055, risk: "medium" },
  { symbol: "EKGYO", name: "Emlak Konut GYO", sector: "Gayrimenkul", descriptionTr: `${SIMULATION_NOTE_TR} Konut projeleri ve gayrimenkul geliştirme temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents housing projects and real estate development themes.`, price: 33, volatility: 0.057, risk: "medium" },
  { symbol: "TRGYO", name: "Torunlar GYO", sector: "Gayrimenkul", descriptionTr: `${SIMULATION_NOTE_TR} Alışveriş merkezi, ofis ve gayrimenkul portföyü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents malls, offices and real estate portfolio themes.`, price: 45, volatility: 0.054, risk: "medium" },
  { symbol: "TKFEN", name: "Tekfen", sector: "İnşaat", descriptionTr: `${SIMULATION_NOTE_TR} Taahhüt, tarım sanayi ve proje yönetimi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents contracting, agribusiness and project management themes.`, price: 51, volatility: 0.058, risk: "medium" },
  { symbol: "CIMSA", name: "Çimsa", sector: "Çimento", descriptionTr: `${SIMULATION_NOTE_TR} Çimento, yapı malzemeleri ve altyapı talebi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents cement, building materials and infrastructure demand themes.`, price: 57, volatility: 0.052, risk: "medium" },
  { symbol: "AKCNS", name: "Akçansa", sector: "Çimento", descriptionTr: `${SIMULATION_NOTE_TR} Çimento üretimi ve inşaat talebi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents cement production and construction demand themes.`, price: 62, volatility: 0.049, risk: "medium" },
  { symbol: "LOGO", name: "Logo Yazılım", sector: "Yazılım", descriptionTr: `${SIMULATION_NOTE_TR} Kurumsal yazılım ve dijital dönüşüm temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents enterprise software and digital transformation themes.`, price: 68, volatility: 0.064, risk: "high" },
  { symbol: "KAREL", name: "Karel", sector: "Teknoloji", descriptionTr: `${SIMULATION_NOTE_TR} Telekom ekipmanları, elektronik ve iletişim teknolojileri temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents telecom equipment, electronics and communication technology themes.`, price: 43, volatility: 0.068, risk: "high" },
  { symbol: "KONTR", name: "Kontrolmatik", sector: "Teknoloji", descriptionTr: `${SIMULATION_NOTE_TR} Otomasyon, enerji teknolojileri ve mühendislik temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents automation, energy technologies and engineering themes.`, price: 77, volatility: 0.082, risk: "high" },
  { symbol: "ALFAS", name: "Alfa Solar", sector: "Yenilenebilir Enerji", descriptionTr: `${SIMULATION_NOTE_TR} Güneş paneli üretimi ve yenilenebilir enerji temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents solar panel manufacturing and renewable energy themes.`, price: 72, volatility: 0.079, risk: "high" },
  { symbol: "CWENE", name: "CW Enerji", sector: "Yenilenebilir Enerji", descriptionTr: `${SIMULATION_NOTE_TR} Güneş enerjisi ekipmanları ve proje geliştirme temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents solar energy equipment and project development themes.`, price: 65, volatility: 0.077, risk: "high" },
  { symbol: "ENJSA", name: "Enerjisa", sector: "Enerji", descriptionTr: `${SIMULATION_NOTE_TR} Elektrik dağıtımı, perakende enerji ve altyapı temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents electricity distribution, retail energy and infrastructure themes.`, price: 59, volatility: 0.044, risk: "medium" },
  { symbol: "AKSEN", name: "Aksa Enerji", sector: "Enerji", descriptionTr: `${SIMULATION_NOTE_TR} Enerji üretimi ve elektrik santrali işletmeciliği temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents power generation and plant operations themes.`, price: 54, volatility: 0.057, risk: "medium" },
  { symbol: "AYDEM", name: "Aydem Enerji", sector: "Enerji", descriptionTr: `${SIMULATION_NOTE_TR} Elektrik üretimi ve yenilenebilir enerji portföyü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents electricity generation and renewable portfolio themes.`, price: 35, volatility: 0.056, risk: "medium" },
  { symbol: "BRYAT", name: "Borusan Yatırım", sector: "Holding", descriptionTr: `${SIMULATION_NOTE_TR} Sanayi, lojistik ve yatırım portföyü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents industrial, logistics and investment portfolio themes.`, price: 112, volatility: 0.063, risk: "high" },
  { symbol: "BRSAN", name: "Borusan Mannesmann", sector: "Sanayi", descriptionTr: `${SIMULATION_NOTE_TR} Boru üretimi, sanayi ve ihracat temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents pipe manufacturing, industry and export themes.`, price: 106, volatility: 0.066, risk: "high" },
  { symbol: "EREGL", name: "Ereğli Demir Çelik", sector: "Sanayi", descriptionTr: `${SIMULATION_NOTE_TR} Demir-çelik üretimi ve küresel emtia döngüsü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents steel production and global commodity cycle themes.`, price: 53, volatility: 0.054, risk: "medium" },
  { symbol: "ISDMR", name: "İskenderun Demir Çelik", sector: "Sanayi", descriptionTr: `${SIMULATION_NOTE_TR} Demir-çelik ve sanayi talebi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents steel and industrial demand themes.`, price: 49, volatility: 0.056, risk: "medium" },
  { symbol: "AKSA", name: "Aksa Akrilik", sector: "Kimya", descriptionTr: `${SIMULATION_NOTE_TR} Elyaf, kimya üretimi ve ihracat temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents fiber, chemical production and export themes.`, price: 58, volatility: 0.052, risk: "medium" },
  { symbol: "GUBRF", name: "Gübretaş", sector: "Kimya", descriptionTr: `${SIMULATION_NOTE_TR} Gübre, tarım girdileri ve hammadde döngüsü temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents fertilizer, agricultural inputs and raw material cycle themes.`, price: 94, volatility: 0.074, risk: "high" },
  { symbol: "SASA", name: "Sasa Polyester", sector: "Kimya", descriptionTr: `${SIMULATION_NOTE_TR} Polyester, petrokimya ve kapasite yatırımı temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents polyester, petrochemicals and capacity investment themes.`, price: 46, volatility: 0.078, risk: "high" },
  { symbol: "KOZAL", name: "Koza Altın", sector: "Madencilik", descriptionTr: `${SIMULATION_NOTE_TR} Altın madenciliği ve emtia fiyatları temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents gold mining and commodity price themes.`, price: 81, volatility: 0.066, risk: "high" },
  { symbol: "IPEKE", name: "İpek Enerji", sector: "Madencilik", descriptionTr: `${SIMULATION_NOTE_TR} Madencilik, enerji ve emtia duyarlılığı temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents mining, energy and commodity sensitivity themes.`, price: 39, volatility: 0.071, risk: "high" },
  { symbol: "MPARK", name: "Medical Park", sector: "Sağlık", descriptionTr: `${SIMULATION_NOTE_TR} Hastane işletmeciliği ve sağlık hizmetleri temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents hospital operations and healthcare services themes.`, price: 76, volatility: 0.05, risk: "medium" },
  { symbol: "ECILC", name: "Eczacıbaşı İlaç", sector: "Sağlık", descriptionTr: `${SIMULATION_NOTE_TR} İlaç, sağlık yatırımları ve tüketim temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents pharmaceuticals, healthcare investments and consumption themes.`, price: 48, volatility: 0.052, risk: "medium" },
  { symbol: "DEVA", name: "Deva Holding", sector: "Sağlık", descriptionTr: `${SIMULATION_NOTE_TR} İlaç üretimi ve sağlık sanayi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents pharmaceutical production and healthcare industry themes.`, price: 57, volatility: 0.057, risk: "medium" },
  { symbol: "MGROS2", name: "Macrocenter", sector: "Perakende", descriptionTr: `${SIMULATION_NOTE_TR} Premium gıda perakendesi ve şehirli tüketim temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents premium food retail and urban consumption themes.`, price: 63, volatility: 0.042, risk: "low" },
  { symbol: "PENTA", name: "Penta Teknoloji", sector: "Teknoloji", descriptionTr: `${SIMULATION_NOTE_TR} Teknoloji dağıtımı ve kurumsal donanım temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents technology distribution and enterprise hardware themes.`, price: 44, volatility: 0.061, risk: "medium" },
  { symbol: "INDES", name: "İndeks Bilgisayar", sector: "Teknoloji", descriptionTr: `${SIMULATION_NOTE_TR} Bilgisayar dağıtımı, donanım ve kanal satış temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents computer distribution, hardware and channel sales themes.`, price: 40, volatility: 0.059, risk: "medium" },
  { symbol: "NETAS", name: "Netaş", sector: "Telekom", descriptionTr: `${SIMULATION_NOTE_TR} Ağ teknolojileri, telekom altyapısı ve yazılım temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents network technologies, telecom infrastructure and software themes.`, price: 37, volatility: 0.07, risk: "high" },
  { symbol: "HEKTS", name: "Hektaş", sector: "Tarım", descriptionTr: `${SIMULATION_NOTE_TR} Tarım kimyasalları, tohum ve üretici talebi temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents agricultural chemicals, seeds and producer demand themes.`, price: 32, volatility: 0.073, risk: "high" },
  { symbol: "TATGD", name: "Tat Gıda", sector: "Gıda İçecek", descriptionTr: `${SIMULATION_NOTE_TR} Paketli gıda, ihracat ve temel tüketim temasını temsil eder.`, descriptionEn: `${SIMULATION_NOTE_EN} Represents packaged food, export and staples themes.`, price: 43, volatility: 0.049, risk: "medium" },
];
