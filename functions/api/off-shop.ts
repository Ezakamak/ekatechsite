...
const SHOP_CATALOG: ShopItem[] = [
  {
    ...
    name: "Pahalı Tesbih",
    emoji: "📿",
    description: "Racon masasında ağır duran koleksiyon tesbihi. Sadece Tech Roulette masasına değer olarak koyulur.",
    price: 25000,
  ...
  },
  {
    ...
    name: "Usta Çakısı",
    emoji: "🔪",
    description: "OFF Hub vitrini için gösterişli çakı. Kumar dışı; yalnızca rulette bahis değeri olarak kullanılabilir.",
    price: 50000,
  ...
  },
  {
    ...
    emoji: "💍",
    description: "Masaya para yerine koymalık pahalı aksesuar. Tech Coin cüzdanından ayrı envanterde saklanır.",
    price: 75000,
  ...
  },
  {
    ...
    name: "Racon Saati",
    emoji: "⌚",
    description: "Masaya sessizce bırakılan ağır kasa saat. Tech Roulette'te yüksek değerli eşya bahsi olarak kullanılır.",
    price: 90000,
  ...
  {
    slug: "altin-kalem",
    name: "Altın İmza Kalemi",
    emoji: "🖋️",
    description: "Anlaşma masası havası veren koleksiyon kalemi. Sadece rulette envanter değeriyle oynanır.",
    price: 110000,
    roulette_value: 110000,
    rarity: "Elit",
  },
  {
    slug: "deri-cuzdan",
    ...
    emoji: "👝",
    description: "OFF Hub kasasında saklanan özel cüzdan. Tech Coin yerine tek kullanımlık masa değeri taşır.",
    price: 135000,
    roulette_value: 135000,
    rarity: "Elit",
  },
  {
    slug: "zafir-kol-dugmesi",
    name: "Zafir Kol Düğmesi",
    emoji: "💠",
    description: "Parlak zafir detaylı gösterişli aksesuar. Roulette masasında nadir eşya bahsi olarak görünür.",
    price: 160000,
    roulette_value: 160000,
    rarity: "Nadir",
  },
  {
    slug: "vintage-cakmak",
    name: "Vintage Çakmak",
    emoji: "🕯️",
    description: "Vitrinlik metal çakmak. Bahis dışı kullanım yoktur; rulette değer jetonu gibi masaya koyulur.",
    price: 190000,
    roulette_value: 190000,
    rarity: "Nadir",
  },
  {
    slug: "kral-muhur-yuzugu",
    name: "Kral Mühür Yüzüğü",
    emoji: "👑",
    description: "En ağır racon koleksiyonu parçası. Tech Roulette için yüksek riskli prestij eşyasıdır.",
    price: 250000,
    roulette_value: 250000,
    rarity: "Efsane",
  },
];
...
export async function onRequestGet(context: any) {
  ...
  try {
    ...
    return Response.json({ ok: true, catalog: SHOP_CATALOG, inventory, wallet });
  } catch (error) {
...
export async function onRequestPost(context: any) {
  ...
  if (!item) return Response.json({ error: "Mağaza ürünü bulunamadı." }, { status: 400 });
  ...
  try {
    ...
    if ((debit.meta?.changes || 0) < 1) {
      return Response.json({ error: "Yetersiz Tech Coin bakiyesi.", wallet: beforeWallet }, { status: 402 });
    }
    ...
    await context.env.DB
      .prepare(`INSERT INTO off_shop_inventory (user_id, item_slug, item_name, emoji, roulette_value, status, acquired_at) VALUES (?, ?, ?, ?, ?, 'available', datetime('now'))`)
    ...
    return Response.json({ ok: true, message: `${item.name} envantere eklendi.`, wallet, inventory });
  } catch (error) {
    return Response.json({ error: readableError(error) }, { status: 500 });
  }
}
...
function readableError(error: unknown) {
  return error instanceof Error ? error.message : "OFF mağaza işlemi tamamlanamadı.";
}
