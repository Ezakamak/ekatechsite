...
export function TechStack() {
  ...
  const copy =
    language === "tr"
      ? {
          heading: "Teknoloji Altyapısı",
          subtitle: "Modern araçlar ve frameworklerle güçlendirilmiş çözümler",
          technologies: [
            { icon: Code2, name: "Python", description: "Backend & AI" },
            { icon: Brain, name: "AI & ML", description: "Zeka sistemleri" },
            { icon: Cloud, name: "Cloudflare", description: "Edge Computing" },
            { icon: Workflow, name: "Otomasyon", description: "İş akışları" },
            { icon: Globe, name: "Web Geliştirme", description: "Modern stack" },
            { icon: Cpu, name: "API'ler", description: "Entegrasyon" },
          ],
        }
      : {
          heading: "Technology Stack",
          subtitle: "Powered by cutting-edge tools and frameworks",
          technologies: [
            { icon: Code2, name: "Python", description: "Backend & AI" },
    ...
    <section id="tech" className="py-32 bg-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {copy.technologies.map((tech, index) => (
            <motion.div
              key={index}
