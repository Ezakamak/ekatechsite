  ...
  useEffect(() => {
    ...
    const scan = () => {
      ...
      banners.forEach((banner) => {
        ...
        const damaging = !healing && !defending && hasAny(text, DAMAGE_TERMS);

        banner.classList.toggle("core-clash-heal-flow", healing);
        banner.classList.toggle("core-clash-defense-flow", defending);
      ...
      hpLabels.forEach((label) => {
        ...
        if (typeof before === "number" && entry.value > before) {
