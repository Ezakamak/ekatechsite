        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[1.6rem] border border-white/10 bg-[#1a2c38]/95 p-4 backdrop-blur-xl sm:p-5">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <button type="button" disabled={isPlayi              <button type="button" disabled={isPlaying || actionLoading || walletLoading} onClick={() => setBetAmount((current) => adjustBetAmount(current, 0.5))} className="rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2 text-xs font-black text-white/70 transition hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-45">
                1/2
>>>>>>>+main
 actionLoading || walletLoading} onClick={() => setBetAmountInput((current) => String(adjustBetAmount(Number(current), 0.5)))} className="rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2 text-xs font-black text-white/70 transition hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-45">
                1/2
>>>>>>> origin/main
              </button>
